...
この変更で **フリーズはほぼ消滅** しました。Tkinter + バックグラウンドスレッド構成のアプリを書くなら、最初からこのパターンを採用することをおすすめします。

:::message alert
「UI 更新を別スレッドから呼んでも一見動く」のが落とし穴です。開発中は問題なくても、本番運用で突然フリーズします。**全 UI 更新をキュー経由に統一する** というルールにしてください。
:::
